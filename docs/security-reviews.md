...
For the current source implementation, start with the [Web edition overview](../README.md#web-edition), [OPAQUE protocol](opaque-protocol-v1.md), [cloud API](cloud-api.md) and [Privacy Policy](../PRIVACY.md). The [two-password prototype](editions-and-encryption.md) is superseded. Dated reports below retain their original scope, test counts and release status; their references to “current,” “pending” or “not yet deployed” describe the reviewed snapshot, not every later release.
...
| OpenAI Codex, 2026-09-14, independent-agent round 1 | Fresh agents separately reviewed server, client and compliance; the coordinating reviewer measured efficiency | [Two-round review summary](independent-security-review-2026-09-14.md) links findings, repairs and focused evidence. Agents started without the implementation conversation; they are still AI reviewers from the same provider. |
| OpenAI Codex, 2026-09-14, independent-agent round 2 | A second set of fresh agents reviewed server/restoration, client lifecycles and compliance/efficiency; a further reviewer crosschecked final changes | [Round 2 and final crosscheck](independent-security-review-2026-09-14.md#review-records). New findings were repaired. Final committed-source CI and live verification are recorded separately in the release PR. |
